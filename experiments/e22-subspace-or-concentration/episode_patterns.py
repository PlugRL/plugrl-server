...
evaluations of an unperturbed actor agree unanimously on 36 of the 50 states
(E21); the rest are the borderline ones where the evaluation's own noise
lives. E21's script, run over E22's arms.
"""
