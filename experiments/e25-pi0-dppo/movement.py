"""How far did DPPO move pi0.5? Compare checkpoints with the base, tensor by tensor.
...
E22's partition - to set beside FPO's first iteration, which moved the
expert 1.51% and the MLP alone enough to destroy the policy (E21, E22).
E26's check_frozen.py, unchanged but for this docstring.
"""
