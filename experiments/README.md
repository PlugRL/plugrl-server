...
| `e2-cross-language` | Can the protocol be spoken by something that is not this codebase? | **Yes** - a 633-line C++ client with no third-party libraries drives a real server |
